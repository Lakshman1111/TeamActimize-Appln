...
const ExpertWiseExperience = () => {
  ...
  const expertfamilywise = useSelector((state) => state.expertWorkExperienceWiseData);
        ...
        <Controls.Paper elevation={1} sx={{ padding: '10px', mb: 2, mt: 2, boxShadow: '0px 10px 80px rgba(0, 0, 0, 0.1)', bgcolor: '#fff', borderRadius: '10px' }} >
          <Controls.Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between', }}>
            <Controls.ResuableHeaderTypo
              ...
              typographyText="Work Experience"
            />
          </Controls.Box>
        </Controls.Paper>
          ...
          <Controls.Paper maxWidth="xlg" sx={{ width: '100%', height: '100%', boxShadow: '0px 10px 80px rgba(0, 0, 0, 0.1)', backgroundColor: '#fff', borderRadius: '5px', p: 5 }}>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, fontWeight: 'bold' }}>Organization Name :</Controls.Typography>
              </Controls.Grid>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16 }}>
                  {expertfamilywise?.data?.data[0]?.organization_name}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, fontWeight: 'bold' }}>Date of Joining :</Controls.Typography>
              </Controls.Grid>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
                  {expertfamilywise?.data?.data[0]?.date_of_join}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, fontWeight: 'bold' }}>Date of End :
                </Controls.Typography>
              </Controls.Grid>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
            ...
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, fontWeight: 'bold' }}>Designation :</Controls.Typography>
              </Controls.Grid>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
                  {expertfamilywise?.data?.data[0]?.designation}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
          </Controls.Paper>
        ...
        <Controls.Grid item xs={12} sm={12} md={3} >
          <Controls.Paper maxWidth="xlg" sx={{ width: '100%', height: '100%', boxShadow: '0px 10px 80px rgba(0, 0, 0, 0.1)', backgroundColor: '#fff', borderRadius: '5px', p: 5 }}>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container>
              ...
              </Controls.Grid>  <Controls.Grid item xs={6} sm={6} md={12} sx={{ width: '100%', height: '100%', }}>
                <Controls.Box component="span" sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'flexstart' }}>
                  <Controls.Typography sx={{
                    fontSize: 16,
                    fontWeight: 'bold',
