...
const ExpertWisetFamily = () => {
  ...
  const expertfamilywise = useSelector((state) => state.expertfimlywiseData);
            ...
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              ...
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16 }}>
                  {expertfamilywise?.data?.data[0]?.name}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              ...
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
                  {expertfamilywise?.data?.data[0]?.email}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              ...
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
                  {expertfamilywise?.data?.data[0]?.address}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              ...
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
                  {expertfamilywise?.data?.data[0]?.relationship}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              ...
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
                  {expertfamilywise?.data?.data[0]?.mobile_number}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
          </Controls.Paper>
                ...
                <Controls.Box component="span" sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'flexstart' }}>
                  <Controls.Typography
                    sx={{
                      ...
                      '&:hover': {
                        textDecoration: 'underline',},}}
                    onClick={() => navigate(`/hr/experts/expertpage/emergencydetails/${id}`)}>Emergency Details</Controls.Typography>
                </Controls.Box>
              </Controls.Grid>
              <Controls.Grid item xs={6} sm={6} md={12} sx={{ width: '100%', height: '100%', }}>
                <Controls.Box component="span" sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'flexstart' }}>
