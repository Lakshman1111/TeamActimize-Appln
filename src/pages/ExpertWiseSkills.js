...
const ExpertWiseSkills = () => {
  ...
  const expertSkillwise = useSelector((state) => state.expertSkillWiseData);
            ...
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              ...
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16 }}>
                  {expertSkillwise?.data?.data[0]?.skill_name}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
            <Controls.Grid rowSpacing={3} columnSpacing={3} container justifyContent={'center'} padding={2}>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, fontWeight: 'bold' }}>Star Rating :</Controls.Typography>
              </Controls.Grid>
              <Controls.Grid item xs={12} sm={12} md={3} sx={{ width: '100%', height: '100%', }}>
                <Controls.Typography sx={{ fontSize: 16, }}>
                  {expertSkillwise?.data?.data[0]?.rating}
                </Controls.Typography>
              </Controls.Grid>
            </Controls.Grid>
          </Controls.Paper>
              ...
              <Controls.Grid item xs={6} sm={6} md={12} sx={{ width: '100%', height: '100%', }}>
                <Controls.Box component="span" sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'flexstart' }}>
                  <Controls.Typography sx={{
                    ...
                    cursor: 'pointer',
                    textDecoration: 'underline',
                    '&:hover': {textDecoration: 'underline', },}}onClick={() => navigate(`/hr/experts/expertpage/leavebank/${id}`)}
